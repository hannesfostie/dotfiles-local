Note: This is a copy from the `thoughtbot/dotfiles` readme at time of installation.

This repository only contains my local files, and the readme itself may go out of date/out of sync. The only reason I copied it here is for faster access to what the files should be called.
